...
// lets learn about Clousers in java script

function clsrFun() {
	let firstName = "Geetesh";
	let lastName = "Patel";
	setTimeout(() => {
		console.log(`Hello..!! ${firstName} ${lastName} Wellcome back`);
	}, 1000);
	return null;
}

clsrFun(); // Output - Hello..!! Geetesh Patel Wellcome back
// a very intresting concepts comes here that
// a setTimeout function or any timer function
// always remembers all the property of it's parent function
// wherever and whenever we invoke the function it will always remember it's lexical scope
// Lexical Scope :- Where the function actually  physically sits.
